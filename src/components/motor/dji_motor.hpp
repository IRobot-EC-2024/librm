...
struct DjiMotorProperties<DjiMotorType::GM6020> {
  ...
  static std::unordered_map<bsp::CanBase *, std::array<u8, 18>> tx_buf_;
};
...
class DjiMotorBase : public bsp::CanDeviceBase {
 ...
 protected:
  DjiMotorBase(bsp::CanBase &can, u16 id);
};
...
class DjiMotor final : public DjiMotorBase {
 public:
  ...
  DjiMotor(bsp::CanBase &can, u16 id);
 ...
 */
template <DjiMotorType motor_type>
DjiMotor<motor_type>::DjiMotor(bsp::CanBase &can, u16 id)
