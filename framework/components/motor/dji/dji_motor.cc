 ...
 */
uint16_t DJIMotorBase::getEncoder() const { return this->ecd_; }

/***
 * @brief   获取电机的转速
 * @return  RPM(rad/s)
 */
uint16_t DJIMotorBase::getRPM() const { return this->rpm_; }

/***
 * @brief   获取电机的实际电流
 * @return  电流值(无单位)
 */
uint16_t DJIMotorBase::getCurrent() const { return this->current_; }

/***
 * @brief   获取电机的温度
 * @return  温度(°C)
 */
uint16_t DJIMotorBase::getTemperature() const { return this->temperature_; }
